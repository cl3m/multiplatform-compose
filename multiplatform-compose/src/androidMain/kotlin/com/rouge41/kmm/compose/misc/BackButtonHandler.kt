...
// https://github.com/vinaygaba/Learn-Jetpack-Compose-By-Example/blob/master/app/src/main/java/com/example/jetpackcompose/state/backpress/BackButtonHandler.kt
...
// built up of smaller composable functions.
@Composable
actual fun BackButtonHandler(onBackPressed: () -> Unit) {
